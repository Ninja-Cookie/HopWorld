...
## Rules
- Each objective on the board is 1 point, a bingo line (5 in a row either vertical, horizontal, or diagonal) is 1 bonus point, so for example, a full vertical line of 5 filled objectives would be 1 point for each objective, plus 1 extra point for the line, equalling a total of 6 points
